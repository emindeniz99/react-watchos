...
|---|---|---|
| ① **Logic-tested** | Pure logic unit-tested off-device | `pnpm test` (320 JS, vitest) + `swift test` (139 test funcs, Linux: Core/Support/Runtime) — counts drift; treat as point-in-time (2026-07-02) |
