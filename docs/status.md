...
| Device info (`getDeviceInfo` + accessibility state + `enableWaterLock`) | ② | invoke routing drift-tested ① (`codegen.test`); WKInterfaceDevice + WKAccessibility snapshot / Water Lock are watchOS-gated ② |
