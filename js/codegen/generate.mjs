...
import { node, structs, tsOnly, hostMethods } from "./schema.mjs";
...
const nodeSwift = () => `struct ${node.swift}: Codable, Equatable, Identifiable {
    let id: Int
    let type: String
...
function swiftModel(target) {
  const parts = [banner(), "import Foundation", "", JSON_VALUE_SWIFT, "", nodeSwift()];
