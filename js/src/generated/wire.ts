...
export const HOST_FEATURES = {"watch":["ai","audio","background","bluetooth","connectivity","core","device","haptics","iap","keychain","location","network","notifications","ota","runtime","sensors","speech","storage","widgets"],"widget":["core","storage","widgets"]} as const;
