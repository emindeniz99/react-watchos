...
export const HOST_FEATURES = {"watch":["ai","audio","background","bluetooth","connectivity","core","device","haptics","iap","keychain","network","notifications","ota","runtime","sensors","speech","storage","widgets"],"widget":["core","storage","widgets"]} as const;
...
export const COMPONENTS = [{"name":"VStack","widget":"full"},{"name":"HStack","widget":"full"},{"name":"ZStack","widget":"full"},{"name":"ScrollView","widget":"degraded"},{"name":"List","widget":"degraded"},{"name":"TabView","widget":"degraded"},{"name":"Spacer","widget":"full"},{"name":"Divider","widget":"full"},{"name":"Text","widget":"full"},{"name":"TimerText","widget":"degraded"},{"name":"Image","widget":"full"},{"name":"Map","widget":"degraded"},{"name":"Gauge","widget":"full"},{"name":"ProgressView","widget":"full"},{"name":"Button","widget":"degraded"},{"name":"Toggle","widget":"degraded"},{"name":"Slider","widget":"degraded"},{"name":"Stepper","widget":"degraded"},{"name":"Picker","widget":"degraded"},{"name":"DatePicker","widget":"degraded"},{"name":"TextField","widget":"degraded"},{"name":"CrownRotation","widget":"degraded"},{"name":"NavigationStack","widget":"degraded"},{"name":"NavigationLink","widget":"degraded"},{"name":"NavigationRoute","widget":"degraded"},{"name":"Alert","widget":"degraded"},{"name":"AlertAction","widget":"degraded"},{"name":"ConfirmationDialog","widget":"degraded"},{"name":"Sheet","widget":"degraded"},{"name":"Section","widget":"degraded"},{"name":"Label","widget":"full"},{"name":"Grid","widget":"full"},{"name":"GridRow","widget":"full"},{"name":"ShareLink","widget":"degraded"},{"name":"Chart","widget":"full"},{"name":"LabeledContent","widget":"full"},{"name":"ContentUnavailable","widget":"full"},{"name":"Toolbar","widget":"degraded"},{"name":"ToolbarItem","widget":"degraded"}] as const;
