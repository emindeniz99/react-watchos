...
export const HOST_FEATURES = {"watch":["ai","background","bluetooth","connectivity","core","device","haptics","iap","keychain","network","notifications","ota","runtime","sensors","speech","storage","widgets"],"widget":["core","storage","widgets"]} as const;
