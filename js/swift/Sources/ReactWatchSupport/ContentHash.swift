...
public enum ContentHash {
    public static func of(_ string: String) -> String { fnv1a(string.utf8) }
    ...
    public static func of(_ data: Data) -> String { fnv1a(data) }

    private static func fnv1a<S: Sequence>(_ bytes: S) -> String
